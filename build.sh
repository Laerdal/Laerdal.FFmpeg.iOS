...
usage(){
    echo "usage: ./build.sh [-p|--package [audio|full|full-gpl|https|https-gpl|min|min-gpl|video]] [-r|--revision build_revision] [-c|--clean-output] [-v|--verbose] [-s|--sharpie] [-o|--output path]"
    echo "parameters:"
