...
namespace Laerdal.Xamarin.FFmpeg.iOS
{
	...
	[BaseType (typeof(NSObject), Name = "MobileFFmpegConfig")]
	interface MobileFFmpegConfig
	{
		// +(void)enableRedirection;
		[Static, Export ("enableRedirection")]
		void EnableRedirection ();

		// +(void)disableRedirection;
		[Static, Export ("disableRedirection")]
		void DisableRedirection ();

		// +(int)getLogLevel;
		[Static, Export ("getLogLevel")]
		int LogLevel { [Bind ("getLogLevel")] get; }
		...
		[Static, Export ("logLevelToString:")]
		...
		[Static, Export ("resetStatistics")]
		void ResetStatistics ();

		// +(void)setFontconfigConfigurationPath:(NSString *)path;
		[Static, Export ("setFontconfigConfigurationPath:")]
		...
		[Static, Export ("getBuildDate")]
		string BuildDate { get; }

		// +(int)getLastReturnCode;
		[Static, Export ("getLastReturnCode")]
		int LastReturnCode { get; }

		// +(NSString *)getLastCommandOutput;
		[Static, Export ("getLastCommandOutput")]
		string LastCommandOutput { get; }

		// +(void)ignoreSignal:(int)signum;
		[Static, Export ("ignoreSignal:")]
		void IgnoreSignal (int signum);
	}
}
